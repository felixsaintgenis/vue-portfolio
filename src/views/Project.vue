				...
				<div class="columns">
					...
					<div class="column is-one-third">
						<div class="columns is-multiline">
							<div class="column is-full" v-for="(image, index) in project.images" :key="index">
								<img :src="image.url"/>
							</div>
						</div>
					</div>
    ...
    project() {
      ...
      if (self.airtableResponse[0]) {
        let thisProject = {
          ...
          snippet: self.airtableResponse[0].fields.Snippet,
          images: self.airtableResponse[0].fields.Attachments,
